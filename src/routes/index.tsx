		...
		<>
			<section class="pd-hero" id="top">
				<div class="area">
					<div class="container g-0 line">
						<div class="row">
							<div class="col-md-6">
								<div class="left">
									<div class="pb-20">
										<h1
											class="typed_title wc-color-white"
									...
									<div class="pb-30 blade">
										...
										>
											<div style="display: block; text-align: start; position: relative; translate: none; rotate: none; scale: none; transform-origin: 286.5px 45px; transform: translate3d(0px, 0px, 0px); opacity: 1;">
												A Digital{' '}
											</div>
											<div style="display: block; text-align: start; position: relative; translate: none; rotate: none; scale: none; transform-origin: 286.5px 45px; transform: translate3d(0px, 0px, 0px); opacity: 1;">
												<span>Product</span>{' '}
							...
							<div class="col-md-6">
								<div class="right">
									<div class="text">
										<div data-on-scroll="0" data-delay="1.2" ref={fadeAnim3}>
											<img
												alt="Shape Image"
												width="37"
												height="37"
										...
										<div class="cf-text" data-delay="1.2" ref={fadeAnim7}>
											<p>
												A Freelance UI/UX Designer and Developer{' '}
												<span>based in Germany</span>. I strives to build
												immersive and beautiful web applications through
												carefully crafted user-centric design.
											</p>
										</div>
									</div>
									<div
						...
						<div class="img_anim_reveal" ref={imgAnim}>
			...
			<div class="row" ref={fadeAnimSecondary}>
				<div class="column medium-2">
					<Image
						src={
							'../../assets/images/photography/blacker/photography_blackerthandays_016-min.jpg'
						}
						height={104}
						width={185}
						alt="test"
						...
						<div class="blog-item-column__content">
							<div class="blog-item blog-item--column-view">
								<div class="blog-item__combo">
									<div class="blog-item__headline">HTML5</div>
				...
				<div class="column medium-12">
					...
					>
						<div class="carousel__buttons">
							<Carousel.Prev class="carousel__prev-button">
								Previous image
							</Carousel.Prev>
							<Carousel.Next class="carousel__next-button">
								Next image
							</Carousel.Next>
						</div>
						<Carousel.View>
									...
									return (
										<div
											class={`carousel__pagination-bullet ${
												currentIndexSig.value === i
													? 'carousel__pagination-underline'
													: ''
											}`}
			...
			<div class="row">
				<div class="column medium-4">
					<div class="blog-item-row">
						<div class="blog-item-row__headline"></div>
