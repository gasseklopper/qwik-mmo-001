			...
			<div class="row">
				<div class="column">
					...
					<p>
						...
						`/src/routes/layout.tsx` layout to wrap the page content.
					</p>
					<h2>More Info:</h2>
					<ul>
						<li>
							<a href="https://qwik.builder.io/qwikcity/layout/overview/">
								Layouts
							</a>
						</li>
						<li>
							<a href="https://qwik.builder.io/qwikcity/routing/overview/">
								Routing
							</a>
						</li>
						<li>
							<a href="https://qwik.builder.io/qwikcity/adaptors/overview/">
								Authoring Content
							</a>
						</li>
						<li>
						...
						<li>
							<a href="https://qwik.builder.io/qwikcity/static-site-generation/overview/">
