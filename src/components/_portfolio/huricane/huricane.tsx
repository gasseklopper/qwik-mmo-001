...
import styles from './huricane.scss?inline'

export default component$(() => {
	useStyles$(styles)

	return (
		<section class={['test', 'huricane']}>
			<Column3 />
		</section>
	)
})
	...
	return (
		<div class="row">
			...
			<div class="column large-4">
				<p>
					huricane tend not to photograph what they can’t see, which is the very
					reason one should try to attempt it. Otherwise we’re going to go on
					forever just photographing more faces and more rooms and more places.
					Photography has to transcend description. It has to go beyond
