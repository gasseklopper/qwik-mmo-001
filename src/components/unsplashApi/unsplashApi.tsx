...
export default component$(() => {
	return (
		<div>
			...
			<br />
			The function `debouncedGetPictures` needs to be exported because it is used in `useWatch$`.
			<br />
			<br />
...
export const AutoApiComplete  = component$(() => {
	...
	useWatch$(async ({ track }) => {
		...
		state.searchResults = await debouncedGetPictures(state.searchInput, controller);
...
const getPictures = (searchInput: string, controller?: AbortController): Promise<string[]> =>
	fetch(`https://api.unsplash.com/search/photos?page=1&query=${searchInput}&client_id=_Kt5cu2YOPFqExISsllw7helHgDv7qBcl6NidJGe5dg`, {
