					...
					<div class="mt-8 lg:-mx-12 lg:flex xl:mt-16">
						<div class="lg:mx-12">
							...
							<div class="mt-4 space-y-4 lg:mt-8">
								<a
									href="#"
									class="block text-blue-500 hover:underline dark:text-blue-400"
								>
									Web design
								</a>
								<a
									href="#"
									class="block text-gray-500 hover:underline dark:text-gray-300"
								>
									App design
								</a>
								<a
					...
					<section class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 xl:mt-12 xl:grid-cols-3">
						<div class="rounded-lg border p-8 dark:border-gray-700">
							<p class="leading-loose text-gray-500 dark:text-gray-400">
								...
								adipisicing elit. Tempore quibusdam ducimus
								libero ad tempora doloribus expedita laborum
								saepe voluptas perferendis delectus assumenda
								rerum, culpa aperiam dolorum, obcaecati corrupti
								aspernatur a.”.
							</p>
				...
				<div class="container mx-auto px-6 pt-28">
					<div class="xl:-mx-8 xl:flex xl:items-center">
						<div class="flex flex-col items-center xl:mx-8 xl:items-start">
							<h1 class="text-3xl font-medium capitalize text-gray-800 dark:text-white lg:text-4xl">
								Our Pricing Plan
							</h1>
						...
						<div class="flex-1 xl:mx-8">
							<div class="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
								<div class="mx-auto max-w-sm rounded-lg border dark:border-gray-700 md:mx-4">
									<div class="p-6">
										<h1 class="text-xl font-medium capitalize text-gray-700 dark:text-white lg:text-3xl">
											Essential
										</h1>
										...
										<button class="mt-6 w-full transform rounded-md bg-blue-600 px-4 py-2 capitalize tracking-wide text-white transition-colors duration-300 hover:bg-blue-500 focus:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
											Start Now
										</button>
									</div>
			...
			<section class="min-h-screen bg-white dark:bg-gray-900 lg:flex">
				...
				<div class="flex w-full flex-col justify-center p-8 pt-0 lg:w-1/2 lg:px-12 xl:px-24">
					<form>
						...
						<button class="mt-4 w-full transform rounded-md bg-blue-500 px-6 py-3 text-sm font-medium capitalize tracking-wide text-white transition-colors duration-300 hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
							get in touch
						</button>
					</form>
				</div>
